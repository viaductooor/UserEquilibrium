...
#Read from ALL tables and write data of a specific period to TR_GPSTRACK_0700_0710
#The data processed satisfies:
#1.Time:7:00am to 7:10am.
#2.Contains:ID,LAT,LON,SPEED_GPS,STATE,DATE_GPS.
#3.Precision:LAT(11,4), LON(11,4), SPEED_GPS(6,1).
#4.All the tables in the program are created before.
