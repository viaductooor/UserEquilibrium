...
public class Winnipeg_asym extends DataSet {

	public Winnipeg_asym() {
		super("files/Winnipeg-Asym_net.txt", "files/Winnipeg-Asym_trips.txt");
	}

	public Winnipeg_asym(String netUrl, String tripUrl) {
